...
function slickArrow(extraClass) {
  return "<svg class=\"slick-arrow " + extraClass + "\" version=\"1.1\" id=\"Ebene_1\" xmlns=\"http://www.w3.org/2000/svg\" x=\"0px\" y=\"0px\"\n" +
    ...
    "\t.st0{fill:#505959;}\n" +
    "</style>\n" +
    "<polygon class=\"st0\" points=\"19.2,37.2 17.8,35.8 29.1,24.5 17.8,13.2 19.2,11.8 31.9,24.5 \"/>\n" +
    "</svg>";
}

var slickPrevArrow = slickArrow('slick-prev');
var slickNextArrow = slickArrow('slick-next');
